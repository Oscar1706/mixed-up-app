  ...
  CommandLineRunner initDatabase(
    ...
    return args -> {
      ...
      accountRepository.save(
          new Account(1l, 0.0, AccountStatus.OPEN.toString(), LocalDateTime.now(), "Ocho"));
      accountRepository.save(
          new Account(
              2l,
              0.0,
      ...
      accountEntryRepository.save(new AccountEntry(2l, 700.0, "SALE", 700.0, LocalDateTime.now()));
      accountEntryRepository
          .findAll()
          .forEach(accountEntry -> log.info("Preloaded: " + accountEntry));
    };
  }
}
